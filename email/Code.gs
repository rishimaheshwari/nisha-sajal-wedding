...
function weddingConfirmation_(job) {
  var events = {
    haldi: { title: 'Haldi', date: 'Saturday, January 30, 2027 · Noon', location: 'Terrace Ballroom', attire: 'Indian / Indo-Western' },
    sangeet: { title: 'Sangeet', date: 'Saturday, January 30, 2027 · Evening', location: 'Clubhouse Ballroom', attire: 'Western / Indo-Western' },
    wedding: { title: 'Wedding & lunch', date: 'Sunday, January 31, 2027 · Morning, followed by lunch', location: 'Clubhouse', attire: 'Royal Traditionals' },
  };
