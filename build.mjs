...
for (const file of ["index.html", "app.js", "styles.css", "enhancements.css", "translations.json"]) {
...
await writeFile(new URL("config.js", dist), `window.WEDDING_CONFIG = ${JSON.stringify(publicRsvpConfig)};\n`);
